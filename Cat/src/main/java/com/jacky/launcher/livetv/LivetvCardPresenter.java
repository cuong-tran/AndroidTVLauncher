package com.jacky.launcher.livetv;
...
public class LivetvCardPresenter extends Presenter {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, Object item) {
        ...
        cardView.getMainImageView().setImageBitmap(livetvModel.getImage());
        cardView.setTitleText(livetvModel.getTitle());
    }
